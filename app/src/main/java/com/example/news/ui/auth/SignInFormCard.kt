...
fun SignInFormCard(
    ...
    Card(
        ...
        Column(
            ...
            Button(
                onClick = { events.onSignIn(email, password) },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(56.dp),
...
@Composable
private fun SignInFormCardPreview() {
    NewsTheme {
        SignInFormCard(
...
@Preview(showBackground = true)
@Composable
private fun SignInFormCardErrorPreview() {
    NewsTheme {
        SignInFormCard(
            email = "user@example.com",
            onEmailChange = {},
...
@Preview(showBackground = true)
@Composable
private fun SignInFormCardLoadingPreview() {
    NewsTheme {
        SignInFormCard(
            email = "user@example.com",
            onEmailChange = {},
